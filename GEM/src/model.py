...
class DownstreamModel(nn.Layer):
    ...
    def forward(self, atom_bond_graphs, bond_angle_graphs, return_graph_encodings=False):
        """
        ...
        if return_graph_encodings:
            return pred, graph_repr  # Return predictions and graph encodings
        else:
            return pred  # Return only predictions as usual
